...
#include <fox/rendering/graphics_api/opengl/core/utility.hpp>
...
namespace fox::gfx::api::glf
{
    ...
    struct     Buffer
    {
        ...
        struct     Mapping
        {
            ...
            enum class RangeAccessFlags : gl::bitfield_t
            {
    ...
    enum class LogicalPixelOperation : gl::enum_t
    {
        Clear        = GL_CLEAR, 
        Set          = GL_SET, 
        Copy         = GL_COPY, 
    ...
    {
        enum class Command : gl::bitfield_t
        {
            None  = GL_NONE, 
    ...
    struct     Texture
    {
        ...
        enum class MagnificationFilter : gl::enum_t
        {
            Nearest = GL_NEAREST, 
            Linear  = GL_LINEAR, 
        };
        enum class MinificationFilter : gl::enum_t
        {
            Nearest              = GL_NEAREST, 
            Linear               = GL_LINEAR, 
    ...
    struct     Tessellation
    {
        enum class Generation : gl::enum_t
        {
            Quads     = GL_QUADS, 
            Triangles = GL_TRIANGLES, 
