...
export namespace fox::input
{
    ...
    auto key_active           (input::key_t    code) -> fox::bool_t
    {
        return api::handler->key_active(code);
    }
    auto key_pressed          (input::key_t    code) -> fox::bool_t
    {
        return api::handler->key_pressed(code);
    }
    auto key_released         (input::key_t    code) -> fox::bool_t
    {
        return api::handler->key_released(code);
    }

    auto button_active        (input::button_t code) -> fox::bool_t
    {
        return api::handler->button_active(code);
    }
    auto button_pressed       (input::button_t code) -> fox::bool_t
    {
        return api::handler->button_pressed(code);
    }
    auto button_released      (input::button_t code) -> fox::bool_t
    {
