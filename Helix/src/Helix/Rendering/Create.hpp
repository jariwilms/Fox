...
namespace hlx::gfx::test
{
    ...
    void test()
    {
        auto vbuf = create<VertexBuffer, Buffer::Access::Static, float>(std::span<const float>{});
        //auto ibuf = create<IndexBuffer, Buffer::Access::Static>();
        //auto ubuf = create<UniformBuffer, int>();
    }
}