...
namespace hlx::gfx::imp::api::gl
{
    ...
    constexpr GLenum      texture_format(gfx::api::Texture::Format format)
    {
        switch (format)
        {
    ...
    constexpr GLenum      texture_format_base(gfx::api::Texture::Format format)
    {
    ...
    constexpr GLenum      texture_min_filter(gfx::api::Texture::Filter filter)
    {
        switch (filter)
        {
    ...
    constexpr GLenum      texture_mag_filter(gfx::api::Texture::Filter filter)
    {
        switch (filter)
        {
            case gfx::api::Texture::Filter::None:      return GL_NEAREST;
    ...
    constexpr GLenum      texture_wrapping(gfx::api::Texture::Wrapping wrapping)
    {
        switch (wrapping)
        {
    ...
    constexpr GLenum      render_buffer_format(gfx::api::Texture::Format format)
    {
        switch (format)
        {
            case gfx::api::Texture::Format::R8_UNORM:          return GL_R8;
    ...
    constexpr GLenum      buffer_target(gfx::api::Buffer::Type type)
    {
        switch (type)
        {
    ...
    constexpr GLbitfield  buffer_access(gfx::api::Buffer::Access access)
    {
        switch (access)
        {
    ...
    constexpr GLenum      buffer_map(gfx::api::Buffer::Mapping mapping)
    {
        switch (mapping)
        {
    ...
    constexpr GLenum      frame_buffer_attachment(gfx::api::FrameBuffer::Attachment attachment)
    {
        switch (attachment)
        {
    ...
    constexpr GLenum      shader_type(gfx::api::Shader::Stage stage)
    {
        switch (stage)
        {
    ...
    constexpr GLenum      shader_stage(gfx::api::Shader::Stage stage)
    {
        switch (stage)
        {
