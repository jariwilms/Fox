...
namespace hlx::gfx::api
{
    ...
    public:
            ...
            : DTexture<D>{ format, filter, wrapping, dimensions }
        {
            ...
            if constexpr (A == AntiAliasing::None) gl::texture_storage_2d(m_glId, m_glFormat, this->m_dimensions, 0);
            ...
            : DTexture<D>{ format, filter, wrapping, dimensions }
        {
            ...
            if constexpr (A == AntiAliasing::None) gl::texture_storage_3d(m_glId, m_glFormat, this->m_dimensions, 0);
