...
namespace fox::gfx
{
    ...
    //using VertexBuffer           = api::gl::Buffer<Buffer::Type::Vertex, ACCESS, T>;
    //template<Buffer::Access ACCESS>
    //using IndexBuffer            = api::gl::Buffer<Buffer::Type::Index, ACCESS, std::uint32_t>;
    //template<typename T>
    //using UniformBuffer          = api::gl::Buffer<Buffer::Type::Uniform, Buffer::Access::Dynamic, T>;
    ////template<Buffer::Access ACCESS, typename T>
    ////using UniformArrayBuffer     = api::gl::Buffer<Buffer::Type::UniformArray, ACCESS, T>;
