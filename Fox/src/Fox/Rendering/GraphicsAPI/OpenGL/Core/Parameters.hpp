...
namespace fox::gfx::api::gl
{
    ...
    using texture_parameter_v = std::variant<gl::minification_p, gl::magnification_p, gl::wrapping_s_p, gl::wrapping_t_p, gl::wrapping_r_p, gl::border_color_p>;
    ...
    using sampler_parameter_v = std::variant<glf::Texture::MinificationFilter, glf::Texture::MagnificationFilter>;
}
