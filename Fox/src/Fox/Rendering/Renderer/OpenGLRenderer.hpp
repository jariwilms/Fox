...
namespace fox::gfx::api
{
    ...
    private:
        ...
        void render_shadow_map(std::shared_ptr<gfx::FrameBuffer> target, const fox::Vector2u& dimensions, const unf::Light& light, fox::float32_t nearPlane, fox::float32_t farPlane);
